...
RSpec.describe "Playthroughs API" do
  describe "POST /playthroughs" do
    it "creates a playthrough" do
      ...
      body = { playthrough: { player_id: player.id, timestamp: 2.years.ago.iso8601, score: 100, time_spent: 60 } }
    ...
    it "returns an error when player is invalid" do
      body = { playthrough: { player_id: 0, timestamp: 2.years.ago.iso8601, score: 100, time_spent: 60 } }
